...
func HasJobs() predicate.Department {
	return predicate.Department(func(s *sql.Selector) {
...
func HasJobsWith(preds ...predicate.Job) predicate.Department {
	return predicate.Department(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasManagerWith(preds ...predicate.User) predicate.Department {
	return predicate.Department(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
